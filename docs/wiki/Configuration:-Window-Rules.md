...
You can find the title and the app ID of a window by running `ymir msg pick-window` and clicking on the window in question.
...
To be precise, they apply at the point when ymir sends the initial configure request to the window.
...
These values instruct ymir to never ask the window to be smaller than the minimum you set, or to be bigger than the maximum you set.
