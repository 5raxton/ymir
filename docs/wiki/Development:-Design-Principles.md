...
The [default config](https://github.com/5raxton/ymir/blob/main/resources/default-config.kdl) is intended to give a familiar, helpful, and not too jarring experience to new ymir users.
