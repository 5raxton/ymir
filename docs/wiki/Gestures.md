...
There are several gestures in ymir.
...
This works with both window-initiated resizes (when using client-side decorations), and ymir-initiated <kbd>Mod</kbd> + right click resizes.
