...
You can find the full list of events along with documentation [here](https://ymir-wm.github.io/ymir/ymir_ipc/enum.Event.html).
...
You can find all available requests and response types in the [ymir-ipc sub-crate documentation](https://ymir-wm.github.io/ymir/ymir_ipc/).
