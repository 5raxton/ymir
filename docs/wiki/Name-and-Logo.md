The name "ymir" is canonically written in lower-case, but feel free to capitalize it if you'd like, especially at the start of sentences where the grammatical rules require it.
...
|        | full-sized                     | icon                           |
|--------|:------------------------------:|:------------------------------:|
| normal | ![](./logo/ymir-logo.svg)      | ![](./logo/ymir-icon.svg)      |
| simple | ![](./logo/ymir-logo-smol.svg) | ![](./logo/ymir-icon-smol.svg) |

The logo is intentionally recolorable.
In fact, there's [a webpage](https://ymirlogo.raurutuchr.ink) that lets you quickly adjust the color and download an SVG.
