...
impl Animation {
    ...
    pub fn replace_config(&mut self, config: ymir_config::Animation) {
        ...
        match config.kind {
            ymir_config::animations::Kind::Spring(p) => {
            ...
            ymir_config::animations::Kind::Easing(p) => {
                *self = Self::ease(
                    self.clock.clone(),
                    self.from,
                    self.to,
...
impl From<ymir_config::animations::Curve> for Curve {
    fn from(value: ymir_config::animations::Curve) -> Self {
        match value {
            ymir_config::animations::Curve::Linear => Curve::Linear,
            ymir_config::animations::Curve::EaseOutQuad => Curve::EaseOutQuad,
            ymir_config::animations::Curve::EaseOutCubic => Curve::EaseOutCubic,
            ymir_config::animations::Curve::EaseOutExpo => Curve::EaseOutExpo,
            ymir_config::animations::Curve::CubicBezier(x1, y1, x2, y2) => {
