...
pub trait YmirInputBackend: input::InputBackend<Device = Self::YmirDevice> {
    type YmirDevice: YmirInputDevice;
}
impl<T: input::InputBackend> YmirInputBackend for T
where
    Self::Device: YmirInputDevice,
{
    type YmirDevice = Self::Device;
}

pub trait YmirInputDevice: input::Device {
...
impl YmirInputDevice for libinput::Device {
...
impl YmirInputDevice for WinitVirtualDevice {
    fn output(&self, _state: &State) -> Option<Output> {
...
impl YmirInputDevice for VirtualPointer {
