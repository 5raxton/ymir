    ...
    pub fn render(
            ...
            .is_some()
        {
            ...
            return ShaderRenderElement::new(
                ...
                1.,
                Rc::new([
                    mat3_uniform("ymir_input_to_geo", input_to_geo),
                    Uniform::new("ymir_geo_size", geo_size.to_array()),
                    mat3_uniform("ymir_geo_to_tex", geo_to_tex),
                    Uniform::new("ymir_progress", progress as f32),
                    Uniform::new("ymir_clamped_progress", clamped_progress as f32),
                    Uniform::new("ymir_random_seed", self.random_seed),
                ]),
                HashMap::from([(String::from("ymir_tex"), buffer.texture().clone())]),
                Kind::Unspecified,
            )
