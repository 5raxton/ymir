//! Window layout logic.
//!
//! Ymir implements scrollable tiling with dynamic workspaces. The scrollable tiling is mostly
...
//!
//! Where possible, ymir tries to follow these principles with regards to outputs:
//!
...
pub trait LayoutElement {
    ...
    fn update_config(&mut self, blur_config: ymir_config::Blur) {
        let _ = blur_config;
    }
    ...
    fn render_normal<R: YmirRenderer>(
        &self,
        ctx: RenderCtx<R>,
        location: Point<f64, Logical>,
        scale: Scale<f64>,
    ...
    fn render_popups<R: YmirRenderer>(
        &self,
        ctx: RenderCtx<R>,
        location: Point<f64, Logical>,
        scale: Scale<f64>,
...
pub struct Options {
    pub layout: ymir_config::Layout,
    pub animations: ymir_config::Animations,
    pub gestures: ymir_config::Gestures,
    pub overview: ymir_config::Overview,
    pub blur: ymir_config::Blur,
    // Debug flags.
...
struct InteractiveMoveData<W: LayoutElement> {
    ...
    pub(self) output_config: Option<ymir_config::LayoutPart>,
    ...
    pub(self) workspace_config: Option<(WorkspaceId, ymir_config::LayoutPart)>,
}
...
impl Options {
    ...
    fn with_merged_layout(mut self, part: Option<&ymir_config::LayoutPart>) -> Self {
...
impl<W: LayoutElement> Layout<W> {
    ...
    pub fn render_interactive_move_for_output<R: YmirRenderer>(
        &self,
        ctx: RenderCtx<R>,
        output: &Output,
