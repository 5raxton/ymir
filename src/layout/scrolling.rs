...
pub struct ScrollingSpace<W: LayoutElement> {
    ...
    ///
    /// Takes into account layer-shell exclusive zones and ymir struts.
...
impl<W: LayoutElement> ScrollingSpace<W> {
    ...
    fn activate_column_with_anim_config(&mut self, idx: usize, config: ymir_config::Animation) {
    ...
    pub fn add_column(
        ...
        mut column: Column<W>,
        activate: bool,
        anim_config: Option<ymir_config::Animation>,
    ) {
...
fn compute_toplevel_bounds(
    border_config: ymir_config::Border,
