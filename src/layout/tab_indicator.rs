...
use ymir_config::{CornerRadius, Gradient, GradientRelativeTo, TabIndicatorPosition};
...
pub struct TabIndicator {
    ...
    config: ymir_config::TabIndicator,
}
...
impl TabIndicator {
    pub fn new(config: ymir_config::TabIndicator) -> Self {
        Self {
            shader_locs: Vec::new(),
            shaders: Vec::new(),
            open_anim: None,
    ...
    pub fn update_config(&mut self, config: ymir_config::TabIndicator) {
        self.config = config;
    }
    ...
    pub fn start_open_animation(&mut self, clock: Clock, config: ymir_config::Animation) {
    ...
    pub fn render(
        &self,
        renderer: &mut impl YmirRenderer,
    ...
    pub fn config(&self) -> ymir_config::TabIndicator {
        self.config
    }
}
