...
impl<W: LayoutElement> Workspace<W> {
    ...
    pub fn update_layout_config(&mut self, layout_config: Option<ymir_config::LayoutPart>) {
    ...
    pub fn render_scrolling<R: YmirRenderer>(
        &self,
        ctx: RenderCtx<R>,
        xray_pos: XrayPos,
        focus_ring: bool,
    ...
    pub fn render_floating<R: YmirRenderer>(
        &self,
        ctx: RenderCtx<R>,
        xray_pos: XrayPos,
        focus_ring: bool,
    ...
    pub fn render_shadow<R: YmirRenderer>(
        &self,
        renderer: &mut R,
...
fn compute_workspace_shadow_config(
    config: ymir_config::WorkspaceShadow,
    view_size: Size<f64, Logical>,
) -> ymir_config::Shadow {
    ...
    let mut config = ymir_config::Shadow::from(config);
