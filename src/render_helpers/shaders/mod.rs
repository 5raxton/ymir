...
use super::renderer::YmirRenderer;
...
impl Shaders {
    fn compile(renderer: &mut GlesRenderer) -> Self {
        ...
        let clipped_surface = renderer
            .compile_custom_texture_shader(
                ...
                &[
                    UniformName::new("ymir_scale", UniformType::_1f),
                    UniformName::new("geo_size", UniformType::_2f),
                    UniformName::new("corner_radius", UniformType::_4f),
                    UniformName::new("input_to_geo", UniformType::Matrix3x3),
                ],
    ...
    pub fn get(renderer: &mut impl YmirRenderer) -> &Self {
...
fn compile_resize_program(
    ...
    ShaderProgram::compile(
        ...
        &program,
        &[
            UniformName::new("ymir_input_to_curr_geo", UniformType::Matrix3x3),
            UniformName::new("ymir_curr_geo_to_prev_geo", UniformType::Matrix3x3),
            UniformName::new("ymir_curr_geo_to_next_geo", UniformType::Matrix3x3),
            UniformName::new("ymir_curr_geo_size", UniformType::_2f),
            UniformName::new("ymir_geo_to_tex_prev", UniformType::Matrix3x3),
            UniformName::new("ymir_geo_to_tex_next", UniformType::Matrix3x3),
            UniformName::new("ymir_progress", UniformType::_1f),
            UniformName::new("ymir_clamped_progress", UniformType::_1f),
...
fn compile_close_program(
    ...
    ShaderProgram::compile(
        ...
        &program,
        &[
            UniformName::new("ymir_input_to_geo", UniformType::Matrix3x3),
            UniformName::new("ymir_geo_size", UniformType::_2f),
            UniformName::new("ymir_geo_to_tex", UniformType::Matrix3x3),
            UniformName::new("ymir_progress", UniformType::_1f),
            UniformName::new("ymir_clamped_progress", UniformType::_1f),
            UniformName::new("ymir_random_seed", UniformType::_1f),
        ],
        &["ymir_tex"],
    )
}
