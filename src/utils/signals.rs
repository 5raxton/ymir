...
//! never intended to spawn ymir with a nonempty sigmask. It indicates a bug in whoever spawned us,
...
mod platform {
    ...
    pub fn listen(_handle: &calloop::LoopHandle<crate::ymir::State>) {}
...
mod platform {
    ...
    pub fn listen(handle: &calloop::LoopHandle<crate::ymir::State>) {
