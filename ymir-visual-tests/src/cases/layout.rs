...
use ymir::animation::Clock;
use ymir::layout::{ActivateWindow, AddWindowTarget, LayoutElement as _, Options, SizingMode};
use ymir::render_helpers::{RenderCtx, RenderTarget};
use ymir_config::{Color, OutputName, PresetSize};
...
pub struct Layout {
    ...
    clock: Clock,
    layout: ymir::layout::Layout<TestWindow>,
    start_time: Duration,
    ...
    pub fn new(args: Args) -> Self {
        ...
        let options = Options {
            layout: ymir_config::Layout {
                focus_ring: ymir_config::FocusRing {
                    off: true,
                    ..Default::default()
                },
        ...
        let mut layout = ymir::layout::Layout::with_options(clock.clone(), options);
