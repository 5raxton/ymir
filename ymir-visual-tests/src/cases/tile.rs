...
use ymir::layout::Options;
use ymir::render_helpers::xray::XrayPos;
use ymir::render_helpers::{RenderCtx, RenderTarget};
use ymir_config::Color;
...
pub struct Tile {
    window: TestWindow,
    tile: ymir::layout::tile::Tile<TestWindow>,
}
...
impl Tile {
    ...
    pub fn with_window(args: Args, window: TestWindow) -> Self {
        ...
        let mut tile = ymir::layout::tile::Tile::new(
            window.clone(),
            size.to_f64(),
            1.,
            clock,
